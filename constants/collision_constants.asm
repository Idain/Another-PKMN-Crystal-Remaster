...
DEF COLL_STAIRS_DOWN_RIGHT              EQU $d0
DEF COLL_STAIRS_DOWN_LEFT               EQU $d1
DEF COLL_STAIRS_UP_RIGHT                EQU $d2
DEF COLL_STAIRS_UP_LEFT                 EQU $d3
DEF COLL_STAIRS_UP_LEFT_UP_RIGHT        EQU $d4
DEF COLL_STAIRS_DOWN_LEFT_UP_RIGHT      EQU $d5
DEF COLL_STAIRS_UP_LEFT_DOWN_RIGHT      EQU $d6
DEF COLL_STAIRS_DOWN_LEFT_DOWN_RIGHT    EQU $d7
