...
CinnabarIsland_MapEvents:
	def_warp_events
	warp_event 15, 15, CINNABAR_POKECENTER_1F, 1

	def_coord_events

	def_bg_events
	bg_event 16, 15, BGEVENT_READ, CinnabarIslandPokecenterSign
	bg_event 13, 15, BGEVENT_READ, CinnabarIslandGymSign
	bg_event 11, 11, BGEVENT_READ, CinnabarIslandSign
	bg_event 15,  3, BGEVENT_ITEM, CinnabarIslandHiddenRareCandy

	def_object_events
	object_event  9, 11, SPRITE_BLUE, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CinnabarIslandBlue, EVENT_BLUE_IN_CINNABAR
