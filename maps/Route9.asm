...
Route9_MapEvents:
	...
	def_bg_events
	bg_event 23, 12, BGEVENT_READ, Route9Sign
	bg_event 41,  6, BGEVENT_ITEM, Route9HiddenEther

	def_object_events
	object_event 22, 18, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 3, TrainerCamperDean, -1
	...
	object_event 12, 22, SPRITE_LASS, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 1, TrainerPicnickerEdna, -1
