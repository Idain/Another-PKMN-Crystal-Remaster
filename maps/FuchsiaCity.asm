...
FuchsiaCity_MapEvents:
	def_warp_events
	warp_event 17, 17, FUCHSIA_MART, 2
	warp_event 22, 13, SAFARI_ZONE_MAIN_OFFICE, 1
	warp_event  8, 25, FUCHSIA_GYM, 1
	warp_event 11, 25, BILLS_BROTHERS_HOUSE, 1
	warp_event 19, 25, FUCHSIA_POKECENTER_1F, 1
	warp_event 27, 25, SAFARI_ZONE_WARDENS_HOME, 1
	...
	bg_event  5, 26, BGEVENT_READ, FuchsiaGymSign
	bg_event 25, 15, BGEVENT_READ, SafariZoneOfficeSign
	bg_event 28, 25, BGEVENT_READ, WardensHomeSign
	bg_event 25,  5, BGEVENT_READ, SafariZoneClosedSign
	bg_event 21,  9, BGEVENT_READ, NoLitteringSign
	bg_event 20, 25, BGEVENT_READ, FuchsiaCityPokecenterSign
	bg_event 18, 17, BGEVENT_READ, FuchsiaCityMartSign

	def_object_events
	object_event 23, 21, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, FuchsiaCityYoungster, -1
	...
	object_event 31,  7, SPRITE_TEACHER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, FuchsiaCityTeacher, -1
	object_event  7,  4, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, FuchsiaCityFruitTree, -1
