...
NationalParkBugContestSootheBell:
...
NationalParkBugContest_MapEvents:
	...
	object_event 35, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, NationalParkBugContestSootheBell, EVENT_NATIONAL_PARK_SOOTHE_BELL
