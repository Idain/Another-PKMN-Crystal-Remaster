...
Route19_MapEvents:
	...
	def_bg_events
	bg_event  9, 15, BGEVENT_READ, Route19Sign
	...
	object_event  8,  5, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 1, Route19Fisher1Script, -1
