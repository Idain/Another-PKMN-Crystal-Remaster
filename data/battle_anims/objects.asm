...
; ANIM_OBJ_POKE_BALL_BG
	battleanimobj ABSOLUTE_X, $00, BATTLEANIMFRAMESET_POKE_BALL_1, BATTLEANIMFUNC_POKEBALL_BG, PAL_BATTLE_OB_GREEN, ANIM_GFX_POKE_BALL_BG
...
; ANIM_OBJ_MASTER_BALL_SPARKLE
	battleanimobj RELATIVE_X, $b8, BATTLEANIMFRAMESET_CIRCLING_SPARKLE, BATTLEANIMFUNC_RECOVER, PAL_BATTLE_OB_YELLOW, ANIM_GFX_SPEED
; ANIM_OBJ_RECOVER
...
; ANIM_OBJ_VINE_WHIP1
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_VINE_WHIP_1, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GREEN, ANIM_GFX_WHIP
; ANIM_OBJ_VINE_WHIP2
...
; ANIM_OBJ_SANDSTORM
	battleanimobj ABSOLUTE_X, $00, BATTLEANIMFRAMESET_SANDSTORM, BATTLEANIMFUNC_RAIN_SANDSTORM, PAL_BATTLE_OB_BROWN, ANIM_GFX_POWDER
; ANIM_OBJ_ZAP_CANNON
...
; ANIM_OBJ_RAIN
	battleanimobj ABSOLUTE_X, $00, BATTLEANIMFRAMESET_RAIN, BATTLEANIMFUNC_RAIN_SANDSTORM, PAL_BATTLE_OB_BLUE, ANIM_GFX_WATER
; ANIM_OBJ_SNOW
	battleanimobj ABSOLUTE_X, $00, BATTLEANIMFRAMESET_SNOW, BATTLEANIMFUNC_RAIN_SANDSTORM, PAL_BATTLE_OB_BLUE, ANIM_GFX_ICE
; ANIM_OBJ_PSYCH_UP
...
; ANIM_OBJ_LEER_SHINE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_LEER_SHINE, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_YELLOW, ANIM_GFX_SPEED	
; ANIM_OBJ_SUNNY_DAY
	battleanimobj ABSOLUTE_X, $00, BATTLEANIMFRAMESET_MORNING_SUN, BATTLEANIMFUNC_SWAGGER_MORNING_SUN, PAL_BATTLE_OB_YELLOW, ANIM_GFX_SHINE	
; ANIM_OBJ_MOONBLAST
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_MOONBLAST, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_YELLOW, ANIM_GFX_CHARGE  
; ANIM_OBJ_MOON
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_SEISMIC_TOSS, BATTLEANIMFUNC_STRENGTH_SEISMIC_TOSS, PAL_BATTLE_OB_GRAY, ANIM_GFX_MOON 
; ANIM_OBJ_MOON_CHARGE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_CHARGE_ORB_2, BATTLEANIMFUNC_RECOVER, PAL_BATTLE_OB_YELLOW, ANIM_GFX_CHARGE 
