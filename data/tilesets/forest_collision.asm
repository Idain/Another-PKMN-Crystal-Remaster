	...
	tilecoll FLOOR, HEADBUTT_TREE, WALL, HEADBUTT_TREE ; 2c
	tilecoll TALL_GRASS, TALL_GRASS, TALL_GRASS, TALL_GRASS ; 2d
	tilecoll TALL_GRASS, TALL_GRASS, TALL_GRASS, TALL_GRASS ; 2e
	tilecoll TALL_GRASS, HEADBUTT_TREE, TALL_GRASS, HEADBUTT_TREE ; 2f
	tilecoll WALL, TALL_GRASS, TALL_GRASS, TALL_GRASS ; 30
	tilecoll HEADBUTT_TREE, TALL_GRASS, HEADBUTT_TREE, TALL_GRASS ; 31
