...
MapGroup_Dungeons:
	...
	map GoldenrodDeptStoreB1F, TILESET_UNDERGROUND, DUNGEON, LANDMMUSIC_RADIO_TOWER, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Violet:
	...
	map Route35NationalParkGate, TILESET_GATE, INDOOR, MUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route36RuinsOfAlphGate, TILESET_GATE, GATE, LANDMARK_ROUTE_36, MUSIC_ROUTE_36, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route36NationalParkGate, TILESET_GATE, INDOOR, MUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Goldenrod:
	map Route34, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_34, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map GoldenrodCity, TILESET_JOHTO_MODERN, TOWN, LANDMMUSIC_RADIO_TOWER, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map GoldenrodGym, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodBikeShop, TILESET_CHAMPIONS_ROOM, INDOOR, LANDMMUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodHappinessRater, TILESET_HOUSE, INDOOR, LANDMMUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BillsFamilysHouse, TILESET_HOUSE, INDOOR, LANDMMUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodMagnetTrainStation, TILESET_TRAIN_STATION, INDOOR, LANDMMUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodFlowerShop, TILESET_HOUSE, INDOOR, LANDMMUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodPPSpeechHouse, TILESET_HOUSE, INDOOR, LANDMMUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodNameRater, TILESET_HOUSE, INDOOR, LANDMMUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore1F, TILESET_MART, INDOOR, LANDMMUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore2F, TILESET_MART, INDOOR, LANDMMUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore3F, TILESET_MART, INDOOR, LANDMMUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore4F, TILESET_MART, INDOOR, LANDMMUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore5F, TILESET_MART, INDOOR, LANDMMUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore6F, TILESET_MART, INDOOR, LANDMMUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStoreElevator, TILESET_MART, INDOOR, LANDMMUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStoreRoof, TILESET_MART, INDOOR, LANDMMUSIC_RADIO_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
