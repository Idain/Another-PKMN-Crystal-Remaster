...
BlueGroup:
	...
	db 56, PIDGEOT, 	NO_ITEM,   		QUICK_ATTACK, RETURN, WING_ATTACK, MIRROR_MOVE
	db 56, ALAKAZAM, 	NO_ITEM,		THUNDER_WAVE, RECOVER, PSYCHIC_M, REFLECT
	db 56, RHYDON, 		NO_ITEM,		CURSE, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	...
	db 58, ARCANINE, 	PINK_BOW,   	CRUNCH, BODY_SLAM, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
