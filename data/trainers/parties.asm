...
ClairGroup:
	...
	db 38, GYARADOS,  NO_ITEM, 		CRUNCH, TWISTER, DRAGON_RAGE, DRAGONBREATH
...
RedGroup:
	...
	db 77, ESPEON, 		TWISTEDSPOON,	HIDDEN_POWER, REFLECT, MORNING_SUN, PSYCHIC_M
	db 77, SNORLAX, 	LEFTOVERS,		CURSE, EARTHQUAKE, REST, RETURN
	db 77, VENUSAUR, 	MIRACLE_SEED,	SUNNY_DAY, GIGA_DRAIN, SYNTHESIS, SOLARBEAM
	db 77, CHARIZARD, 	CHARCOAL,  		FLAMETHROWER, WING_ATTACK, SLASH, EARTHQUAKE
	db 77, BLASTOISE, 	MYSTIC_WATER,  	RAIN_DANCE, SURF, ICE_BEAM, HYDRO_PUMP
	db -1 ; end 
