...
FalknerGroup:
	...
	db  9, PIDGEY,     TACKLE, SAND_ATTACK, MUD_SLAP, NO_MOVE
...
MortyGroup:
	...
	db 21, HAUNTER, NO_ITEM,   	HYPNOSIS, DREAM_EATER, CURSE, NIGHT_SHADE
	db 25, GENGAR,  GOLD_BERRY, HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 23, HAUNTER, NO_ITEM,   	SPITE, MEAN_LOOK, CURSE, NIGHT_SHADE
	db -1 ; end
...
BrunoGroup:
	...
	db 46, MACHAMP,    GOLD_BERRY, 	ROCK_SLIDE, FORESIGHT, REVENGE, CROSS_CHOP
	db -1 ; end
...
LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_ITEM__MOVES
...
; ----------------------------------------------------------------------
	...
	; RIVAL2 (5)
	db "?@", TRAINERTY PE_ITEM_M OVES
	db 58, SNEASEL,    NEVERMELTICE,  	METAL_CLAW, SCREECH, FAINT_ATTACK, ICE_PUNCH
	db 58, CROBAT,     PINK_BOW,  		TOXIC, RETURN, CONFUSE_RAY, WING_ATTACK
	db 58, MAGNETON,   MAGNET,  		THUNDER, TRI_ATTACK, THUNDER_WAVE, THUNDERBOLT
	db 58, GENGAR,     SPELL_TAG,  		HYPNOSIS, THUNDERBOLT, SHADOW_BALL, CONFUSE_RAY
	db 58, ALAKAZAM,   TWISTEDSPOON,  	RECOVER, TOXIC, PSYCHIC_M, REFLECT
	db 60, TYPHLOSION, CHARCOAL,  		THUNDER_PUNCH, EARTHQUAKE, FIRE_BLAST, SWIFT
	db -1 ; end
