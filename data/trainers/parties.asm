...
RedGroup:
	...
	db 77, SNORLAX, 	LEFTOVERS,		CURSE, EARTHQUAKE, REST, DOUBLE_EDGE
...
BlueGroup:
	...
	db 58, GYARADOS, 	MYSTIC_WATER,   THUNDER, HYDRO_PUMP, RAIN_DANCE, DOUBLE_EDGE
	db 58, EXEGGUTOR, 	TWISTEDSPOON,  	SUNNY_DAY, LEECH_SEED, PSYCHIC_M, SOLARBEAM
