...
BugsyGroup:
	...
	db 15, BEEDRILL, NO_ITEM,		FOCUS_ENERGY, HARDEN, TWINEEDLE, FURY_ATTACK
...
PryceGroup:
	...
	db 30, SEEL,      NO_ITEM, 		SNORE, ICY_WIND, AURORA_BEAM, REST
	db 32, DEWGONG,   NO_ITEM, 		SLEEP_TALK, ICY_WIND, AURORA_BEAM, REST
	db 34, PILOSWINE, GOLD_BERRY, 	ICY_WIND, EARTHQUAKE, HEADBUTT, BLIZZARD
	db -1 ; end
...
JasmineGroup:
	...
	db 32, MAGNETON,  NO_ITEM, 		THUNDERBOLT, DOUBLE_TEAM, TRI_ATTACK, THUNDER_WAVE
...
ChuckGroup:
	...
	db 29, PRIMEAPE,  NO_ITEM,  	LEER, DOUBLE_TEAM, KARATE_CHOP, ROCK_SLIDE
	db 29, HITMONTOP, NO_ITEM,		MACH_PUNCH, PURSUIT, DOUBLE_TEAM, TRIPLE_KICK
...
ClairGroup:
	...
	db 38, GYARADOS,  NO_ITEM, 		CRUNCH, WATERFALL, DRAGON_RAGE, OUTRAGE
	db 38, DRAGONAIR, NO_ITEM, 		THUNDER_WAVE, SURF, SLAM, DRAGONBREATH
	db 38, DRAGONAIR, NO_ITEM, 		THUNDER_WAVE, FIRE_BLAST, SLAM, DRAGONBREATH
	db 41, KINGDRA,   GOLD_BERRY, 	SMOKESCREEN, HYDRO_PUMP, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
; ----------------------------------------------------------------------
	...
	db 30, MAGNEMITE,  SPARK, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
	...
	db 32, HAUNTER,    CONFUSE_RAY, MEAN_LOOK, CURSE, SHADOW_BALL
	db 34, SNEASEL,    ICE_PUNCH, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 34, FERALIGATR, THRASH, WATER_GUN, CRUNCH, SCARY_FACE
	db -1 ; end
; ----------------------------------------------------------------------
	; RIVAL1 (13)
	db "?@", TRAINERTYPE_MOVES
	db 38, SNEASEL,    ICE_PUNCH, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 38, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 38, MAGNETON,   SPARK, SUPERSONIC, THUNDER_WAVE, SWIFT
	db 38, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 38, KADABRA,    DISABLE, PSYBEAM, RECOVER, REFLECT
	db 40, MEGANIUM,   REFLECT, PETAL_DANCE, POISONPOWDER, SYNTHESIS
	db -1 ; end
	...
	db 38, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 38, KADABRA,    DISABLE, PSYBEAM, RECOVER, REFLECT
	db 40, TYPHLOSION, FLAMETHROWER, SWIFT, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 38, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 38, KADABRA,    DISABLE, PSYBEAM, RECOVER, REFLECT
	db 40, FERALIGATR, CRUNCH, WATERFALL, SCARY_FACE, SLASH
	db -1 ; end
; ----------------------------------------------------------------------
PokemonProfGroup:
...
WillGroup:
	...
	db 41, XATU,      NO_ITEM, 	QUICK_ATTACK, SHADOW_BALL, CONFUSE_RAY, PSYCHIC_M
	db 41, JYNX,      NO_ITEM, 	DREAM_EATER, LOVELY_KISS, ICE_BEAM, PSYCHIC_M
	db 41, EXEGGUTOR, NO_ITEM, 	REFLECT, LEECH_SEED, GIGA_DRAIN, PSYCHIC_M
	db 41, SLOWBRO,   NO_ITEM, 	CURSE, AMNESIA, SURF, PSYCHIC_M
	db 43, XATU,      GOLD_BERRY, QUICK_ATTACK, SHADOW_BALL, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
KarenGroup:
	...
	db 45, MURKROW,   NO_ITEM, 	QUICK_ATTACK, WHIRLWIND, PURSUIT, FAINT_ATTACK
...
KogaGroup:
	...
	db 42, ARIADOS,    NO_ITEM, 	DOUBLE_TEAM, SLUDGE_BOMB, BATON_PASS, GIGA_DRAIN
	db 42, VENOMOTH,   NO_ITEM, 	SUPERSONIC, GUST, PSYCHIC_M, TOXIC
	db 42, FORRETRESS, LEFTOVERS, 	PROTECT, GIGA_DRAIN, EXPLOSION, SPIKES
	db 42, MUK,        LEFTOVERS, 	MINIMIZE, CURSE, SLUDGE_BOMB, TOXIC
...
ChampionGroup:
	...
	db 49, DRAGONITE,  NO_ITEM, 	THUNDER_WAVE, DRAGONBREATH, THUNDER, HYPER_BEAM
	db 49, DRAGONITE,  NO_ITEM, 	THUNDER_WAVE, DRAGONBREATH, BLIZZARD, HYPER_BEAM
...
BrockGroup:
	...
	db 52, GRAVELER,  NO_ITEM, 	DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 52, RHYHORN,   NO_ITEM, 	SANDSTORM, SCARY_FACE, EARTHQUAKE, HORN_DRILL
	db 53, OMASTAR,   NO_ITEM, 	ANCIENTPOWER, SURF, PROTECT, SPIKE_CANNON
	db 54, ONIX,      GOLD_BERRY, IRON_TAIL, ROCK_SLIDE, SCREECH, SANDSTORM
	db 52, KABUTOPS,  NO_ITEM, 	SLASH, SURF, ROCK_SLIDE, GIGA_DRAIN
	db -1 ; end
...
LtSurgeGroup:
	...
	db 51, RAICHU,     NO_ITEM, THUNDER_WAVE, QUICK_ATTACK, THUNDERBOLT, DOUBLE_TEAM
	db 51, ELECTRODE,  NO_ITEM, SCREECH, DOUBLE_TEAM, THUNDERBOLT, EXPLOSION
	db 51, ELECTRODE,  NO_ITEM, THUNDER_WAVE, DOUBLE_TEAM, THUNDERBOLT, LIGHT_SCREEN
	db 51, MAGNETON,   NO_ITEM, LOCK_ON, DOUBLE_TEAM, TRI_ATTACK, ZAP_CANNON
	db 53, ELECTABUZZ, GOLD_BERRY, QUICK_ATTACK, THUNDERBOLT, LIGHT_SCREEN, THUNDER
	db -1 ; end
...
ErikaGroup:
	...
	db 54, JUMPLUFF,   NO_ITEM, SUNNY_DAY, LEECH_SEED, COTTON_SPORE, GIGA_DRAIN
...
JanineGroup:
	...
	db 48, CROBAT,   NO_ITEM,  SCREECH, SUPERSONIC, CONFUSE_RAY, WING_ATTACK
	db 48, WEEZING,  NO_ITEM,  THUNDERBOLT, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 48, ARIADOS,  NO_ITEM,  SCARY_FACE, PIN_MISSILE, PSYCHIC_M, SLUDGE_BOMB
	db 48, ARIADOS,  NO_ITEM,  SWAGGER, PIN_MISSILE, GIGA_DRAIN, SLUDGE_BOMB
	db 50, VENOMOTH, GOLD_BERRY,  FORESIGHT, DOUBLE_TEAM, GUST, PSYCHIC_M
	db -1 ; end
...
; ----------------------------------------------------------------------
	...
	db 58, GENGAR,     SPELL_TAG,  		HYPNOSIS, THUNDERBOLT, SHADOW_BALL, CONFUSE_RAY
	db 58, ALAKAZAM,   TWISTEDSPOON,  	RECOVER, TOXIC, PSYCHIC_M, REFLECT
	db 60, TYPHLOSION, CHARCOAL,  		THUNDERPUNCH, EARTHQUAKE, FIRE_BLAST, SWIFT
	db -1 ; end
...
BlaineGroup:
	...
	db 59, RAPIDASH, PINK_BOW,  QUICK_ATTACK, RETURN, MEGAHORN, FIRE_BLAST
	db -1 ; end
