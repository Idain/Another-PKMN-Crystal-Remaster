...
.one
	...
	ld a, [hl]
	cp $70
	jp c, BattleAnimFunction_ThrowFromUserToTarget
...
.anon_dw
	...
	dw .three
	dw .four ; ret
	dw DeinitBattleAnimation ; Clears Egg Bomb object via anim_incobj
...
.anon_dw
	dw .zero
	dw .one
	dw DeinitBattleAnimation ; anim_incobj forces obj to deinit
...
; Object moves upward for 12 frames and switches to BATTLEANIMFRAMESET_SLUDGE_BUBBLE_BURST
	call BattleAnim_AnonJumptable
.anon_dw
	dw .zero
	dw .one
